...
const InputNumeroComponent = ({updateNumber, updateBase}) => {
    ...
    return (
        <div className='container'>
            <input type="text" placeholder='10010' className="numero" id="numero" onChange={event => updateNumber(event.target.value.toUpperCase())} />
